            ...
            <div class="col-md-12">
                <form method="post">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $query = mysqli_query($koneksi, "UPDATE peminjaman SET id_buku='$id_buku_baru', tanggal_peminjaman='$tanggal_peminjaman', tanggal_pengembalian='$tanggal_pengembalian', status_peminjaman='$status_peminjaman' WHERE id_peminjaman=$id");
                        if ($query) {
